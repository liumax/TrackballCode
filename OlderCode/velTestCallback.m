...
if scQtUserData.plotCounter == 10
    scQtUserData.lastPoint = scQtUserData.velCounter - 1;
...
%     scQtUserData.velEnd(scQtUserData.trial) = find(scQtUserData.velocity(:,1)>scQtUserData.master(scQtUserData.trial,10)+2000);
    ...
    size(scQtUserData.velocity(:,1))
    size(scQtUserData.velocity(:,2))
    scQtUserData.firstPoint
    scQtUserData.lastPoint
    
    title(scQtUserData.velAx,'Mouse Speed (cm/s)'), ...
    plot((scQtUserData.velocity(scQtUserData.firstPoint:scQtUserData.lastPoint,1)...
    -scQtUserData.velocity(1,1))/1000,scQtUserData.velocity(scQtUserData.firstPoint...
    :scQtUserData.lastPoint,2)*2*0.1,'color','k','linewidth',2,...
    'parent',scQtUserData.velAx);

    set(scQtUserData.velAx,'ygrid','on');
    scQtUserData.firstPoint = scQtUserData.lastPoint;
end
