...
if (~isempty(strfind(newLine,'SoundOff'))) && scQtUserData.tripSwitch == 0;
    ...
    sendScQtControlMessage(['sound = ',num2str(scQtUserData.master(scQtUserData.trial,12))]);
    sendScQtControlMessage(['rewProb = ',num2str(scQtUserData.master(scQtUserData.trial,4))]);
