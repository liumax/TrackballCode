function createFilterFrameworkSpikesFiles(dest,animalID,sessionNum)
%createFilterFrameworkSpikesFiles(dest,animalID,sessionNum)
%
%This function extracts sorted spike information from matclust files 
%and saves data in the FilterFramework format. It is assumed that there is
