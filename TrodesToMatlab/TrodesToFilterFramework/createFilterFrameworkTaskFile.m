function createFilterFrameworkTaskFile(dest,animalID,sessionNum)
%createFilterFrameworkTaskFile(dest,animalID,sessionNum)
%
%This function extracts task information from a recording session 
%and saves data in the FilterFramework format. It is assumed there is at
