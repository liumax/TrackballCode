function createFilterFrameworkTrialFiles(dest,animalID,sessionNum, varargin)
%
%createFilterFrameworkTrialFiles('an123_121214_scLog.txt',[],[],'inputWatch',[1:3],'trialStartTerms',{'initiate'},'trialEndTerms',{'initiate'},'checkMessageTerms',{'LEDStim'})
