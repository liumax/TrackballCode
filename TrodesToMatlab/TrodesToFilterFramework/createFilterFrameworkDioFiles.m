function createFilterFrameworkDioFiles(dest,animalID,sessionNum)
%createFilterFrameworkDioFiles(dest,animalID,sessionNum)
%
%This function saves DIO data in the FilterFramework format. It is assumed that there is
