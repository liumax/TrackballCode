function [overOut,indivOut,s,masterData,masterHeader,masterInd] = functionTuningDataExtractionTarget(numUnits,numDBs,numFreqs,uniqueFreqs,s,masterData,masterHeader,masterInd,histBinVector,totalTrialNum,master,desigNames,calcWindow,histBinNum,whiteStatus);
...
%     [generalResponseHist] = functionBasicResponseSignificance(s,calcWindow,spikeTimes,alignTimes,length(master));
    ...
    probSpikeTar = zeros(numFreqs,numDBs);
    ...
    for k = 1:numFreqs
        ...
        for l = 1:numDBs
            ...
            [latPeakBinOut] = functionLatPeakBinCalculationTarget(targetWindow,s.Parameters.RasterWindow,...
