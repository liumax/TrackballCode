...
function [s] = functionBasicTuning(fileName);
...
%Stores parameters in s.
s.Params.RasterWindow = rasterWindow;
s.Params.RPVTime = rpvTime;
s.Params.ClusterWindow = clusterWindow;
s.Params.HistogramBin = histBin;
s.Params.SampleRate = sampleRate;
s.Params.DefaultBins = defaultBins;
s.Params.SmoothingBins = smoothingBins;
s.Params.CalcWindow = calcWindow;
s.Params.zLimit = zLimit;
s.Params.FirstSpikeWindow = firstSpikeWindow;
s.Params.ChosenSpikeBin = chosenSpikeBin;
s.Params.BaselineBin = baselineBin;
s.Params.LFPWindow = lfpWindow;
