...
fileName = '160411_ML160218E_L17_3137_toneFinder';
...
%%
%extracts DIO stuffs!
dioName = strcat(fileName,'.dio_D1.dat');
...
for i = 1:size(uniqueFreqs,1)
    ...
    master(sortingFinder,4) = sortingCounter:1:sortingCounter + size(sortingFinder,1) - 1;
...
for i = 1:numTrodes
    ...
    for j = 1:clusterSizer
        ...
        for k = 1:length(inTimes)
            ...
            toneRaster(rasterHolder:rasterHolder + length(toneHolder)-1,4) = master(k,4);
