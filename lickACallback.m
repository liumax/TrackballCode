...
if (~isempty(strfind(newLine,'SoundOff')))
    scQtUserData.trial = scQtUserData.trial + 1;
    sendScQtControlMessage(['disp(''Trial = ',num2str(scQtUserData.trial),''')']);
    sendScQtControlMessage(['itiDur = ',num2str(scQtUserData.master(scQtUserData.trial,2)-1000)]); %-1000 is fudge to allow trial states to work
...
if (~isempty(strfind(newLine,'SoundOff'))) && scQtUserData.trial>1
    ...
    title(scQtUserData.corrAx,[...
        ...
        ' Black = prelick',' Blue = Anticipatory', ' Green = post']), ...
    % Plot pre-licks
    plot(1:scQtUserData.trial,scQtUserData.master(1:scQtUserData.trial,6),'linewidth',3,...
        'color','k','parent',scQtUserData.corrAx);
    % Plot anticipatory licks
    plot(1:scQtUserData.trial,scQtUserData.master(1:scQtUserData.trial,7),'linewidth',3,...
        'color','b','parent',scQtUserData.corrAx);
    %Plot post-delivery licks
    plot(1:scQtUserData.trial,scQtUserData.master(1:scQtUserData.trial,8),'linewidth',3,...
    ...
    set(scQtUserData.corrAx,'ylim',[0 15],'ytick',0:1:15,'ygrid','on');
