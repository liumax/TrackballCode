...
%Bioheat Equation (Pennes, 1948). Must be run after MonteCarloLight.
%
%Inputs:
...
spheat=3650*10^3; %specific heat of brain (ibid)
kbrain=.527; %whole brain thermal diffusivity constant;
wb=8.5*10^-3; %blood perfusion rate of brain (ibid; units converted)
pblood=3.6*10^6; %specific heat of blood (ibid; units converted)
densblood=1.06*10^-6; %density of blood (ibid; units converted)
%(units converted)
