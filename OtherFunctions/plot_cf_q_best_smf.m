function plot_cf_q_best_smf(rtf_params, ptparams)
...
fitmodel = fit(ptposition(:), cf(:), 'smoothingspline', 'SmoothingParam', 0.5e-5);
[cfdata] = feval(fitmodel, posdata);
plot(cfdata, posdata, 'k-', 'linewidth', 1);

plot(cf, ptposition, 'ko', 'markerfacecolor','k', 'markersize', 3);
set(gca,'xscale', 'log');
box on;
axis([1000 100000 0 2200]);
plot([1000 100000],[layer4 layer4],'k:');
plot([1000 100000],[layer5 layer5],'k:');
plot([1000 100000],[layer6 layer6],'k:');
plot([1000 100000],[whitematter whitematter],'k-');

set(gca,'ytick',[0 layer4 layer5 layer6 whitematter], 'yticklabel', [0 layer4 layer5 layer6 whitematter]);
...
plot(qdata, posdata, 'k-', 'linewidth', 1);
plot(q, ptposition, 'ko', 'markerfacecolor','k', 'markersize', 3);
box on;
rax = 8;
lax = 0;
...
set(gca,'xtick', [0:2:8], 'xticklabel', [0:2:8]);
set(gca,'ytick',[0 layer4 layer5 layer6 whitematter], 'yticklabel', [0 layer4 layer5 layer6 whitematter]);
xlabel('Spectral Selectivity (Q)');
set(gca,'ydir','rev');
set(gca, 'tickdir', 'out', 'ticklength', [0.025 0.025]);
...
subplot(3,1,3);
hold on;
plot(best_smf, position, 'ko', 'markerfacecolor','k', 'markersize', 3);
...
set(gca, 'xtick', [0:1:3], 'xticklabel', [0:1:3]);
set(gca,'ytick',[0 layer4 layer5 layer6 whitematter], 'yticklabel', [0 layer4 layer5 layer6 whitematter]);
set(gca,'ydir','rev');
set(gca, 'tickdir', 'out', 'ticklength', [0.025 0.025]);
...
set(gcf,'position', [360   496   215   426]);
