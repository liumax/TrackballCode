...
% 
%    [bmf, bw6db, bw3db, wc3db] = mtf_bmf_bw_wc(freq, mtf)
% 
%    Calculates best modulation frequency, mtf bandwidth at 3dB and 6dB down,
%    and the high side mtf cutoff at 3dB down.
% 
%    freq : frequency values of the mtf
%    mtf : amplitude values
% 
%    bmf : best modulation frequency
%    bw6db : bandwidth of mtf 6 dB down
%    bw3db : bandwidth of mtf 3 dB down
%    wc3db : cutoff of mtf 3 dB down
% 
%    caa
